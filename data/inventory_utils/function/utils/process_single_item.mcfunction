...
execute if data storage inventory_utils:temp current.components.minecraft:item_name run data modify storage inventory_utils:temp clean_name set from storage inventory_utils:temp current.components.minecraft:item_name
execute unless data storage inventory_utils:temp current.components.minecraft:custom_name unless data storage inventory_utils:temp current.components.minecraft:item_name run function inventory_utils:utils/auto_format_name with storage inventory_utils:temp
