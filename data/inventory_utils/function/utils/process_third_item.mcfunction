data modify storage inventory_utils:temp current_item set from entity @s data.Inventory[2]
...
function inventory_utils:utils/add_third_item with storage inventory_utils:temp
