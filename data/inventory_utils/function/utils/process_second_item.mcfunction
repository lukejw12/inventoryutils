data modify storage inventory_utils:temp current_item set from entity @s data.Inventory[1]
...
function inventory_utils:utils/add_second_item with storage inventory_utils:temp
