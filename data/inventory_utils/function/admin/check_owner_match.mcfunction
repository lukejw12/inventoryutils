...
execute if score #uuid_matches inv_utils.temp matches 0 run scoreboard players add #cache_count inv_utils.cache_count 1
execute if score #is_team_member inv_utils.temp matches 1 run scoreboard players add #cache_count inv_utils.cache_count 1