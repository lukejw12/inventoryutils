...
execute if score #found_index inv_utils.temp = #display_index inv_utils.temp run execute store result storage inventory_utils:temp cache_id int 1 run scoreboard players get @s inventory_utils.id
